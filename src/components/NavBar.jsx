      ...
      <Popover.Group className="hidden lg:flex lg:gap-x-12">
        ...
        <Popover className="relative">
          ...
          <Popover.Button className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900">
            ...
            <ChevronDownIcon className="h-5 w-5 flex-none font-bold text-2xl text-gray-400" aria-hidden="true" />
          </Popover.Button>
          ...
          <div className="-my-6 divide-y divide-gray-500/10">
            <div className="space-y-2 py-6">
              <Disclosure as="div" className="-mx-3">
                {({ open }) => (
                  <>
                    <Disclosure.Button className="flex w-full text-xl items-center justify-between rounded-lg py-2 pl-3 pr-3.5 font-bold  leading-7 text-gray-900 hover:bg-gray-50">
                      Muvie
                      <ChevronDownIcon
