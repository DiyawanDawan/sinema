...
const API_ENDPOINT = {
    ...
    RECOMENDATION_MUVIE: (id) => `${CONFIG.BASE_URL}/movie/${id}/recommendations${CONFIG.DEFAULT_LANGUAGE}`,
    RECOMENDATION: (id) => `${CONFIG.BASE_URL}/tv/${id}/recommendations${CONFIG.DEFAULT_LANGUAGE}`,
